        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/smallten.png" alt="logo" class="block h-14 w-auto fill-current"/>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="flex text-lg font-bold">
                    ...
                    <div class="ml-4">
                        <span class="text-red-600">大吉！！</span>
                        此時
                        <span class="text-red-600">宜</span>
                        購物
                    </div>
                </div>
            </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('cart') }}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             class="bi bi-cart inline" viewBox="0 0 16 16">
                            <path
