...
<x-app-layout>
    ...
    @endif
    <div class="max-w-5xl mx-auto mt-8 pb-8">
        <p class="text-2xl font-bold">商品清單</p>
        ...
        <div class="flex flex-row-reverse mt-12 mb-4">
            <div class="text-2xl mx-8 sm:mx-8 md:mx-12 lg:m-x12 xl:mx-12 2xl:mx-12 font-bold text-red-600">
