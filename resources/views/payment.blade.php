    ...
    <div class="max-w-5xl mx-auto my-8">
        ...
        <form action="{{route('cart.buy')}}" method="post">
            ...
            <div class="mt-4">
                ...
                <select id="payment" name="payment" class="right-0 bg-gray-50 z-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-md origin-top-right focus:ring-blue-500 focus:border-blue-500 block mt-2 w-full p-2.5">
